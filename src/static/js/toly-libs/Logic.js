class Logic {
    ...
    /**
     * 通过图片json数组,获取小图片的base64码
     * 所有小图片放在static/icons文件夹下
     * @returns {*}
     */
    static getImageUrl() {
        let datas = require('../../icons/icon.json');
        for (let i = 0; i < datas.length; i++) {
            let imgData = datas[i];
            imgData.url = require("../../icons/" + imgData.fileName);
            datas[i] = imgData;
        }
        return datas;
    }
